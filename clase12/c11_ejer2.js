...
// Escribe un programa que le pida al usuario ingresar un color del semáforo: rojo, amarillo o verde. Dependiendo del color ingresado, el programa
...
let color = prompt('ingresar un color del semáforo: rojo, amarillo o verde: ').toLowerCase();//Convertís todo a minúsculas
